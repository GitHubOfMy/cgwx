...
class FaceRestoreHelper(object):
    ...
    def init_dlib(self, detection_path, landmark5_path):
        ...
        detection_path = load_file_from_url(url=detection_path, model_dir=os.path.join(folder_paths.models_dir, "codeFormer-pip/weights/dlib"), progress=True, file_name=None)
        #landmark5_path = load_file_from_url(url=landmark5_path, model_dir="weights/dlib", progress=True, file_name=None)
        landmark5_path = load_file_from_url(url=landmark5_path, model_dir=os.path.join(folder_paths.models_dir, "codeFormer-pip/weights/dlib"), progress=True, file_name=None)
