...
def init_retinaface_model(model_name, half=False, device="cuda"):
    ...
    model_path = load_file_from_url(url=model_url, model_dir=os.path.join(folder_paths.models_dir, "codeFormer-pip/weights/facelib"), progress=True, file_name=None)
